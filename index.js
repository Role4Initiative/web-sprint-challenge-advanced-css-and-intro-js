...
function get20s(array) {
  const sameCenturyDeaths = [];
  for(let i = 0; i < array.length; i++){
    if(array[i].years >= '1900' && array[i].years <= '2000' ){
      sameCenturyDeaths.push(array[i].name);
    }
  }
  return sameCenturyDeaths;
}
...
console.log('Task 6 =', addArtist(artists, 20,
  'Benjamin Robert Rusinowski', 
  '1991 - current day',
  'Web Design', 
  'Mutt',
  'Ben is known to be a newly found artist in web design. He lived how he died, in the future.'));
